...
<%
	...
	ResultSet rs = st.executeQuery("Select * from mails where Ruser='"+user+"' and id > "+request.getParameter("id")+" and Rdelete=0 ORDER BY id DESC" );
	String text="{\"records\":[";
	while(rs.next()){
	st = con.createStatement();	
	ResultSet rsi =st.executeQuery("Select Name from userauthentication where Email='"+rs.getString("Suser")+"'");
	rsi.next();
